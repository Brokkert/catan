...
export const RULES_1 = [
  // BORD
  { id: 'procedureel', cat: 'bord', name: 'Procedurele ontdekking', desc: 'Begin met alleen hoofdeiland + waterring. Alle ontdekkingstegels leg je vooraf geshuffled in de Ontdekking-bak (volgorde onbekend voor iedereen); tijdens spel pak je de volgende tegel uit het eerstvolgende vak. Elke game is anders.', def: true, core: true },
